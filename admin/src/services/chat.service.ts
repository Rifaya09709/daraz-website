...
// Creates the socket connection once and reuses it — called after login,
// with the JWT passed in the handshake so the server can auth the socket
...
// ===============================
// REST calls — conversation setup & history
// ===============================
